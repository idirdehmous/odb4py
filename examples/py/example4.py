...
"""
Send the SQL query and retrieve the data as a pandas dataframe !
...
# Let's get the AMDAR data (obstype = 5 ) and the coordinates lat/lon in degrees
# The SQL query
...
df = DataFrame(conn.odb_dict  (database  =dbpath,
                      sql_query =sql    ,
                      nfunc     =nf     ,
                      fmt_float =ndigits,
                      queryfile =sql_file,
